...
static rosidl_typesupport_introspection_c__MessageMember MoveCircle_Request__rosidl_typesupport_introspection_c__MoveCircle_Request_message_member_array[10] = {
  {
    "pose1",  // name
